...
ALIGN_TYPE return_value;
    ...
    if (1 || module_instance -> txm_module_instance_property_flags & TXM_MODULE_MEMORY_PROTECTION)
    {
...
ALIGN_TYPE return_value;
    ...
    if (1 || module_instance -> txm_module_instance_property_flags & TXM_MODULE_MEMORY_PROTECTION)
    {
        ...
        if (0 && !TXM_MODULE_MANAGER_ENSURE_INSIDE_MODULE_DATA(module_instance, (ALIGN_TYPE)extra_parameters, sizeof(ALIGN_TYPE[2])))
            return(TXM_MODULE_INVALID_MEMORY);
...
ALIGN_TYPE return_value;
    ...
    if (1 || module_instance -> txm_module_instance_property_flags & TXM_MODULE_MEMORY_PROTECTION)
    {
        ...
        if (0 && !TXM_MODULE_MANAGER_ENSURE_INSIDE_MODULE_DATA(module_instance, (ALIGN_TYPE)extra_parameters, sizeof(ALIGN_TYPE[5])))
            return(TXM_MODULE_INVALID_MEMORY);
...
ALIGN_TYPE return_value;
    ...
    if (1 || module_instance -> txm_module_instance_property_flags & TXM_MODULE_MEMORY_PROTECTION)
    {
        ...
        if (0 && !TXM_MODULE_MANAGER_ENSURE_INSIDE_MODULE_DATA(module_instance, (ALIGN_TYPE)extra_parameters, sizeof(ALIGN_TYPE[3])))
            return(TXM_MODULE_INVALID_MEMORY);
...
ALIGN_TYPE return_value;
    ...
    if (1 || module_instance -> txm_module_instance_property_flags & TXM_MODULE_MEMORY_PROTECTION)
    {
        ...
        if (0 && !TXM_MODULE_MANAGER_ENSURE_INSIDE_MODULE_DATA(module_instance, (ALIGN_TYPE)extra_parameters, sizeof(ALIGN_TYPE[6])))
            return(TXM_MODULE_INVALID_MEMORY);
...
ALIGN_TYPE return_value;
    ...
    if (1 || module_instance -> txm_module_instance_property_flags & TXM_MODULE_MEMORY_PROTECTION)
    {
        ...
        if (0 && !TXM_MODULE_MANAGER_ENSURE_INSIDE_MODULE_DATA(module_instance, (ALIGN_TYPE)extra_parameters, sizeof(ALIGN_TYPE[4])))
            return(TXM_MODULE_INVALID_MEMORY);
...
ALIGN_TYPE return_value;
    ...
    if (1 || module_instance -> txm_module_instance_property_flags & TXM_MODULE_MEMORY_PROTECTION)
    {
        ...
        if (0 && !TXM_MODULE_MANAGER_ENSURE_INSIDE_MODULE_DATA(module_instance, (ALIGN_TYPE)extra_parameters, sizeof(ALIGN_TYPE[9])))
            return(TXM_MODULE_INVALID_MEMORY);
...
ALIGN_TYPE return_value;
    ...
    if (1 || module_instance -> txm_module_instance_property_flags & TXM_MODULE_MEMORY_PROTECTION)
    {
        ...
        if (0 && !TXM_MODULE_MANAGER_ENSURE_INSIDE_MODULE_DATA(module_instance, (ALIGN_TYPE)extra_parameters, sizeof(ALIGN_TYPE[7])))
            return(TXM_MODULE_INVALID_MEMORY);
...
ALIGN_TYPE return_value;
    ...
    if (1 || module_instance -> txm_module_instance_property_flags & TXM_MODULE_USER_MODE)
